...
class mark_attendance:
    def __init__(self,root):
        ...
        self.root.title("MARK ATTENDANCE | Shivam & Molik ")
...
#=================title=================
        header = Label(root,text="MARK ATTENDANCE",bg="white",fg="blue",font=("verdana", 36,"bold"))
        header.pack(fill=X)
        ...
        t_img1=t_img.resize((96,96), Image.Resampling.LANCZOS)
 ...
 #=================left lable frame=================
        ...
        left_frame.place(x=10,y=120,width=570,height=230)
...
#=================Attendance Status=================
        attendanceLable=Label(left_inside_frame,text="Status",font=("comicsansns",14,"italic"),fg="blue",bg="white")
...
#=================button frames=================
        ...
        save_btn=Button(btn_frame,text="Set Attendance",command=self.set_attendance,width=13,font=("comicsansns",11,"italic"),bg="blue",fg="white")
