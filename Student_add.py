...
class Student_add:
    def __init__(self,root):
        ...
        self.root.iconbitmap("img/attendence_icon.ico")
        self.root.title("ADD STUDENT | Shivam & Molik")
...
#=================title=================
        header = Label(root,text="ATTENDANCE MANAGEMENT SYSTEM",bg="white",fg="blue",font=("verdana", 36,"bold"))
        header.pack(fill=X)
        ...
        self.title_img1 = ImageTk.PhotoImage(t_img) 
 ...
 #=================left lable frame=================
        left_frame=LabelFrame(main_frame,bd=2,bg='white', relief= RIDGE,fg="blue",text="Student Details",font=("comicsansns",12,"italic"))
...
#=================Enrollment Number=================
        attendaceID_lable=Label(left_inside_frame,text="Enrollment No.",font=("comicsansns",14,"italic"),fg="blue",bg="white")
...
#=================Rollno=================
        rollLable=Label(left_inside_frame,text="RollNo",font=("comicsansns",14,"italic"),fg="blue",bg="white")
...
#=================Name=================
        nameLable=Label(left_inside_frame,text="Name",font=("comicsansns",14,"italic"),fg="blue",bg="white")
...
#=================Department=================
        depLable=Label(left_inside_frame,text="Department",font=("comicsansns",14,"italic"),fg="blue",bg="white")
...
#=================Subject=================
        subjectLable=Label(left_inside_frame,text="Subject",font=("comicsansns",14,"italic"),fg="blue",bg="white")
...
#=================Date=================
        dateLable=Label(left_inside_frame,text="Date",font=("comicsansns",14,"italic"),fg="blue",bg="white")
...
#=================button frames=================
        ...
        save_btn=Button(btn_frame,text="Save",command=self.add_students,width=13,font=("comicsansns",11,"italic"),bg="blue",fg="white")
        save_btn.grid(row=0,column=0,padx=5)

        update_btn=Button(btn_frame,text="Update",command=self.update_student,width=13,font=("comicsansns",11,"italic"),bg="blue",fg="white")
        update_btn.grid(row=0,column=1,padx=5)

        delete_btn=Button(btn_frame,text="Delete",command=self.delete_data,width=13,font=("comicsansns",11,"italic"),bg="blue",fg="white")
        delete_btn.grid(row=0,column=2,padx=5)

        reset_btn=Button(btn_frame,text="Reset",command=self.reset_data,width=13,font=("comicsansns",11,"italic"),bg="blue",fg="white")
        reset_btn.grid(row=0,column=3,padx=8)


#=================RIGHT lable frame=================
        right_frame=LabelFrame(main_frame,bd=2,bg='white', fg="blue",relief= RIDGE,text="Attendance Details",font=("comicsansns",12,"italic"))
...
#export csv...................
    ...
    def delete_data(self):
        con=mysql.connector.connect(host="localhost",port=3307,user="root",password="mysql",database="attendance")
        cur=con.cursor()
        cur.execute("delete from students where RollNo=%s",self.var_atten_roll.get())
        con.commit()
        con.close()
        self.fetch_data()
        self.clear() 
